...
interface DoubtTheaterProps {
  ...
  refreshStatsTrigger?: () => void;
}

export function DoubtTheater({ onDebateChanged, refreshStatsTrigger }: DoubtTheaterProps) {
      ...
      <CardContent className="p-4 space-y-4">
        ...
        <form onSubmit={handleSimulateDoubt} className="flex gap-2">
          ...
          <Button
            ...
            className="text-[9px] font-black tracking-widest uppercase shrink-0 h-9 rounded-xl px-4 bg-rose-950/40 hover:bg-rose-900/60 border border-rose-500/30 text-rose-300 shadow-[0_0_10px_rgba(244,63,94,0.2)]"
          >
