/** * Simulation Dashboard */ "use client";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="rounded-lg bg-background p-3 dark:bg-card">
                {" "}
                <p className="text-xs font-medium text-foreground0 mb-1">
                  Best Case
                </p>{" "}
              ...
              <div className="rounded-lg bg-red-50 p-3 dark:bg-red-950/20">
                {" "}
                <p className="text-xs font-medium text-destructive-foreground mb-1">
                  Worst Case
                </p>{" "}
              ...
              <div className="space-y-3">
                ...
                {result.downstreamEffects.map((effect, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">
                      {(effect.probability * 100).toFixed(0)}%
                    </span>{" "}
                  </div>
                ))}
              </div>{" "}
