/** * Economic Overview Dashboard */ "use client";
            ...
            <div key={analysis.actionId} className="rounded-lg border p-4">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-medium">
                  Action {analysis.actionId}
                </span>{" "}
                <Badge
                  variant={
                    analysis.roiPercentage > 0 ? "default" : "destructive"
                  }
                >
                  {" "}
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between">
                  {" "}
                  <span className="text-foreground0">Benefit</span>{" "}
                  <span>${analysis.totalBenefit.toFixed(2)}</span>{" "}
                </div>{" "}
                <div className="flex justify-between">
                  {" "}
                  <span className="text-foreground0">NPV</span>{" "}
                  <span
                    className={
