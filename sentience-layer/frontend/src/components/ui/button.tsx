...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-[#EAB308] text-black shadow hover:bg-[#EAB308]/90 font-bold",
        destructive:
          "bg-red-600 text-white shadow-sm hover:bg-red-600/90",
        outline:
          "border border-zinc-800 bg-transparent shadow-sm hover:bg-purple-900/20 hover:text-[#EAB308]",
        secondary:
          "bg-zinc-800 text-slate-50 shadow-sm hover:bg-zinc-700",
        ghost: "hover:bg-purple-900/10 hover:text-[#EAB308]",
